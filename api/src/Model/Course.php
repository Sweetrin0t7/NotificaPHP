...
class Course implements \JsonSerializable {
   ...
   //construtor
   public function __construct(string $name, int $periods, ?int $id = null) {
   ...
   //métodos SET
   public function setId(int $id) { //repare que id só admite nulo no processo de criação, aqui não!
      $this->id = $id;
   }
   ...
   public function setPeriods(int $periods) {
      $this->periods = $periods;
   }
